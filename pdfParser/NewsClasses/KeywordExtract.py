...
class KeywordExtract:
    ...
    def keywordExtract(self):
        ...
        newsObjectList = News().selectByIDDate(cur,politicianList[0].politicianID,\
                                             startdate="2022-08-01", enddate="2022-08-11")
        ...
        for _, k in zip(range(len(keywords)), ext_topic_cluster.keys()):
            ...
            for key, value in ext_topic_cluster[k][1].items():
                ...
                newsKeyword.politicianID = politicianList[0].politicianID
